...
# Menghitung akar kuadrat sebuah bilangan
...
print("3. Mencari akar kuadrat sebuah bilangan")
...
if(menu==1):
    ...
    bil1 = float(input("Masukkan bilangan yang ingin dicari akar kuadratnya: "))
    print(bil1**0.5)
